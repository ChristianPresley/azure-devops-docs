...
:::row:::
   ...
   :::column span="1":::
      ...
      #### Variables
      - [Create a variable](../pipelines/variables/index.md?tabs=azure-devops-cli%2Cbatch#create-a-variable)
      - [Delete a variable](../pipelines/variables/index.md?tabs=azure-devops-cli%2Cbatch#delete-a-variable)
      - [List variables](../pipelines/variables/index.md#list-variables)
      - [Update a variable](../pipelines/variables/index.md?tabs=azure-devops-cli%2Cbatch#update-a-variable)
